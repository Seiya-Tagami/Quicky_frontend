...
In the version 1.1, I improve whole of the application UI, but specifically, I work hard to review MemoItem UI and make it better. Also, I changed font color.
## License
